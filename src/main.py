...
source_melbourne = XMLTV("https://xmltv.net/xml_files/Melbourne.xml", "Pro:Centric JSON Program Guide Data AUS Melbourne")
...
XMLTVProcess(source_melbourne, ["EPG", "AU", "Melbourne"], "Procentric_EPG_MEL")
